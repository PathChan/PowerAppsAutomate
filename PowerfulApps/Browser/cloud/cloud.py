"""Empty cloud browser stubs - cloud support removed in PowerfulApps."""
...
class CloudBrowserClient:
	"""Stub client - cloud browser not supported in PowerfulApps."""

	def __init__(self, *args: Any, **kwargs: Any) -> None:
		self.current_session_id: str | None = None

	async def create_browser(self, *args: Any, **kwargs: Any) -> Any:
		raise CloudBrowserError('Cloud browser support removed in PowerfulApps')
