...
from PowerfulApps.Browser.utils.moc_llm_messages import SystemMessage, UserMessage
...
""".strip()
	...
	async def _extract_clean_markdown(self, extract_links: bool = False) -> tuple[str, dict]:
		...
		Returns empty content since markdown extraction is not available in MVP.
		"""
		return '', {}
