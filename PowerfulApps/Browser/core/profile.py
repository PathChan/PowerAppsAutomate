...
from PowerfulApps.Browser.cloud.views import CloudBrowserParams
from PowerfulApps.Browser.utils.moc_config import CONFIG
from PowerfulApps.Browser.utils.moc_utils import _log_pretty_path, logger
...
# Using constants from central location in PowerfulApps.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use PowerfulApps.Browser.profile.ProxySettings(server, bypass, username, password)',
	)
