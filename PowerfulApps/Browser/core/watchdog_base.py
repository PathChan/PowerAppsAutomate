...
class BaseWatchdog(BaseModel):
	...
	def attach_to_session(self) -> None:
		...
		from PowerfulApps.Browser.core import events as _browser_events

		event_classes = {}
		for name in dir(_browser_events):
			obj = getattr(_browser_events, name)
	...
	def __del__(self) -> None:
		...
		try:
			...
			from PowerfulApps.Browser.utils.moc_utils import logger
