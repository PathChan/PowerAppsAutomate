...
from PowerfulApps.DOM.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
from PowerfulApps.Browser.utils.moc_observability import observe_debug
from PowerfulApps.Browser.utils.moc_utils import create_task_with_error_handling, time_execution_async

if TYPE_CHECKING:
	from PowerfulApps.Browser.core.views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
	...
	async def _get_pending_network_requests(self) -> list['NetworkRequest']:
		...
		"""
		from PowerfulApps.Browser.core.views import NetworkRequest
...
"""
	...
	async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> 'BrowserStateSummary':
		...
		"""
		from PowerfulApps.Browser.core.views import BrowserStateSummary, PageInfo
	...
	def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list['PaginationButton']:
		...
		"""
		from PowerfulApps.Browser.core.views import PaginationButton
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from PowerfulApps.Browser.core.views import PageInfo
