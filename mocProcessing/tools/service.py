...
from mocProcessing.agent.views import ActionModel, ActionResult
...
from mocProcessing.browser.views import BrowserError
...
from mocProcessing.utils import create_task_with_error_handling, sanitize_surrogates, time_execution_sync
	...
	def __init__(
		...
		async def extract(
			...
			if output_schema is not None:
				try:
					from mocProcessing.tools.extraction.schema_utils import schema_dict_to_pydantic_model
			...
			from mocProcessing.dom.markdown_extractor import chunk_markdown_by_structure
...
""".strip()
				...
				try:
					...
					from mocProcessing.tools.extraction.views import ExtractionResult
...
""".strip()
		...
		async def select_dropdown(params: SelectDropdownOptionAction, browser_session: BrowserSession):
			...
			from mocProcessing.browser.events import SelectDropdownOptionEvent
