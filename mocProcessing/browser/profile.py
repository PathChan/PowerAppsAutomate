...
from mocProcessing.browser.cloud.views import CloudBrowserParams
from mocProcessing.config import CONFIG
from mocProcessing.utils import _log_pretty_path, logger
...
# Using constants from central location in mocProcessing.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use mocProcessing.browser.profile.ProxySettings(server, bypass, username, password)',
	)
